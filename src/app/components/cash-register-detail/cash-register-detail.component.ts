...
@Component({
  ...
  styleUrl: './cash-register-detail.component.css',
  providers: [DatePipe]
})
export class CashRegisterDetailComponent {
  ...
  deleteById(model: CashRegisterDetailModel){
    this.swal.callSwal("Delete Hasa action?",`Do you want to delete the action with description ${model.description} at ${model.date}?`,()=> {
